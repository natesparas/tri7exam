!function(e, t) {
    ...
    function t() {
        null !== y.previousBodyPadding && (document.body.style.paddingRight = y.previousBodyPadding,
    ...
    function r() {
        ...
        case "object":
            ...
            break;
        default:
            return console.error('SweetAlert2: Unexpected type of argument! Expected "string" or "object", got ' + typeof arguments[0]),
            !1
        }
        Z(e);
        var t = w();
        return new Promise(function(n, o) {
            function r(t, n) {
                for (var o = A(e.focusCancel), r = 0; r < o.length; r++) {
                    t += n,
                    t === o.length ? t = 0 : -1 === t && (t = o.length - 1);
                    var i = o[t];
                    if (j(i))
                        return i.focus()
                }
            ...
            function l(t) {
                ...
                if (-1 !== [9, 13, 32, 27].indexOf(a)) {
                    ...
                    9 === a ? (n.shiftKey ? r(c, -1) : r(c, 1),
                    D(n)) : 13 === a || 32 === a ? -1 === c && (e.focusCancel ? W(b, n) : W(g, n)) : 27 === a && e.allowEscapeKey === !0 && (i.closeModal(e.onClose),
                    o("esc"))
                }
            }
            e.timer && (t.timeout = setTimeout(function() {
                i.closeModal(e.onClose),
                o("timer")
            }, e.timer));
            var s = function(n) {
                switch (n = n || e.input) {
            ...
            var d, p = function(t) {
                ...
                e.preConfirm ? e.preConfirm(t, e.extraParams).then(function(o) {
                    i.closeModal(e.onClose),
                    n(o || t)
                }, function(e) {
                    i.hideLoading(),
                ...
                case "click":
                    if (s && i.isVisible())
                        if (e.input) {
                            var d = u();
                            e.inputValidator ? (i.disableInput(),
                            e.inputValidator(d, e.extraParams).then(function() {
                                i.enableInput(),
                                p(d)
                            }, function(e) {
                                i.enableInput(),
                        ...
                        c && i.isVisible() && (i.closeModal(e.onClose),
                        o("cancel"))
                }
            ...
            var g = E()
              , b = B();
            e.reverseButtons ? g.parentNode.insertBefore(b, g) : g.parentNode.insertBefore(g, b),
            y.previousWindowKeyDown = window.onkeydown,
            window.onkeydown = l,
            e.buttonsStyling && (g.style.borderLeftColor = e.confirmButtonColor,
            ...
            i.hideLoading = i.disableLoading = function() {
                e.showConfirmButton || (O(g),
                e.showCancelButton || O(k())),
                T(g, c.loading),
                T(t, c.loading),
                g.disabled = !1,
                b.disabled = !1
            ...
            "select" !== e.input && "radio" !== e.input || (e.inputOptions instanceof Promise ? (i.showLoading(),
            e.inputOptions.then(function(e) {
                i.hideLoading(),
                Q(e)
            })) : "object" == typeof e.inputOptions ? Q(e.inputOptions) : console.error("SweetAlert2: Unexpected type of inputOptions! Expected object or Promise, got " + typeof e.inputOptions)),
            F(e.animation, e.onOpen),
            r(-1, 1),
            a.scrollTop = 0,
            "undefined" == typeof MutationObserver || m || (m = new MutationObserver(i.recalculateHeight),
            m.observe(t, {
                childList: !0,
                characterData: !0,
                subtree: !0
    ...
    f.length ? a = f[0] : (a = document.createElement("div"),
    ...
    var m, v = function(e, t) {
        ...
        var t = [E(), B()];
        return e && t.reverse(),
        t.concat(Array.prototype.slice.call(w().querySelectorAll("button:not([class^=" + l + "]), input:not([type=hidden]), textarea, select")))
    }, q = function(e, t) {
        ...
        y.previousActiveElement && y.previousActiveElement.focus && y.previousActiveElement.focus(),
        ...
        var t = w();
        for (var n in e)
            d.hasOwnProperty(n) || "extraParams" === n || console.warn('SweetAlert2: Unknown parameter "' + n + '"');
        ...
        e.progressSteps.length ? (H(f),
        N(f),
        m >= e.progressSteps.length && console.warn("SweetAlert2: Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
        e.progressSteps.forEach(function(t, n) {
            var o = document.createElement("li");
            if (M(o, c.progresscircle),
            o.innerHTML = t,
        ...
        e.imageUrl ? (b.setAttribute("src", e.imageUrl),
        H(b),
        ...
        b.className = c.image,
        e.imageClass && M(b, e.imageClass)) : O(b),
        ...
        e.buttonsStyling && (a.style.backgroundColor = e.confirmButtonColor,
        ...
        e.buttonsStyling ? (M(a, c.styled),
        M(l, c.styled)) : (T(a, c.styled),
        T(l, c.styled),
        a.style.backgroundColor = a.style.borderLeftColor = a.style.borderRightColor = "",
        l.style.backgroundColor = l.style.borderLeftColor = l.style.borderRightColor = ""),
        e.animation === !0 ? T(t, c.noanimation) : M(t, c.noanimation)
    }, F = function(t, o) {
        var r = w();
        t ? (M(r, c.show),
        M(a, c.fade),
        T(r, c.hide)) : T(r, c.fade),
        H(r),
        a.style.overflowY = "hidden",
        K && !q(r, c.noanimation) ? r.addEventListener(K, function i() {
    ...
    i.queue = function(e) {
        ...
        return new Promise(function(e, r) {
            !function a(l, s) {
                l < Y.length ? (t.setAttribute("data-queue-step", l),
                i(Y[l]).then(function(e) {
                    o.push(e),
                    a(l + 1, s)
                }, function(e) {
                    n(),
